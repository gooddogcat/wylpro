...
public class StudySqLite2Activity extends Activity {
    public static final String TABLENAME = "stutb";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_study_sq_lite2);
        ...
        db.update("stutb", values, "_id>?", new String[]{"3"});//将全部id>3人的性别改成女
